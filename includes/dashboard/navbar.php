...
<div class="offcanvas offcanvas-start text-bg-dark" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Title of Backdrop</h5>
    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">
        <a href="" type="button" class="btn color-btn rounded-pill bg-primary text-light w-25">Article</a>
        <a href="" type="button" class="btn color-btn rounded-pill bg-primary text-light w-25">Category</a>
    </div>
</div>